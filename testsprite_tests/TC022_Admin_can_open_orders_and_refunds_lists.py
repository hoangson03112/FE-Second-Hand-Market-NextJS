...
async def run_test():
    ...
    try:
        ...
        # -> Fill the username and password fields and submit the login form to sign in as admin, then verify admin navigation becomes available.
        frame = context.pages[-1]
        # Input text
        ...
        frame = context.pages[-1]
        assert await frame.locator("xpath=//*[contains(., 'Refunds')]").nth(0).is_visible(), "The refunds list view should display refund records or an empty state after navigating to the refunds section."
