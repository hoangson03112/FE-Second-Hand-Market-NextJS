...
async def run_test():
    ...
    try:
        ...
        # -> Open the login page by clicking the 'Đăng nhập' link (element index 111).
        ...
        frame = context.pages[-1]
        assert await frame.locator("xpath=//*[contains(., 'Bamboo Mug - Updated')]").nth(0).is_visible(), "The listings page should show the updated listing title Bamboo Mug - Updated after saving changes"
