...
async def run_test():
    ...
    try:
        ...
        # -> Fill in username and password, then submit the login form to authenticate as seller 'viet1'.
        frame = context.pages[-1]
        # Input text
        ...
        frame = context.pages[-1]
        assert await frame.locator("xpath=//*[contains(., 'Đang xử lý')]").nth(0).is_visible(), "The seller orders list should display the updated status Đang xử lý after saving the change"
