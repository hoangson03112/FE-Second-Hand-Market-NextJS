...
async def run_test():
    ...
    try:
        ...
        # -> Fill the username field with 'viet1', fill the password with '12345678nM', then submit the login form.
        frame = context.pages[-1]
        # Input text
        ...
        frame = context.pages[-1]
        assert await frame.locator("xpath=//*[contains(., 'Green Jacket')]").nth(0).is_visible(), "The listings page should display the newly created listing titled Green Jacket after submission."
