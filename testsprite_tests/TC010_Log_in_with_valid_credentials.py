...
async def run_test():
    ...
    try:
        ...
        # -> Click the 'Đăng nhập' link to open the login form (element index 106).
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/header/div/div/div[2]/div/div/a').nth(0)
        await asyncio.sleep(3); await elem.click()
        
        # -> Fill the username field with 'viet1', fill the password field with '12345678nM', then submit the login form by clicking the 'Đăng nhập' button.
        frame = context.pages[-1]
        # Input text
        ...
        frame = context.pages[-1]
        assert await frame.locator("xpath=//*[contains(., 'Đăng xuất')]").nth(0).is_visible(), "The page should show a Đăng xuất link after signing in"
