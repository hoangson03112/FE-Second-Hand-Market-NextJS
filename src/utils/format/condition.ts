...
const CONDITION_MAP: Record<ProductCondition, ConditionInfo> = {
  ...
  like_new: {
    label: "Như mới",
    color: "text-luxury-ink/80",
    badgeColor: "bg-cream-100 text-luxury-ink/80 border-luxury-ink/10",
    description: "Sản phẩm gần như mới, ít dấu hiệu sử dụng",
  },
  good: {
    label: "Tốt",
    color: "text-luxury-ink/70",
    badgeColor: "bg-cream-100/60 text-luxury-ink/70 border-luxury-ink/10",
    description: "Sản phẩm đã qua sử dụng nhưng còn tốt",
  },
  fair: {
    label: "Khá",
    color: "text-neutral-500",
    badgeColor: "bg-cream-50/60 text-neutral-500 border-luxury-ink/10",
    description: "Sản phẩm có dấu hiệu sử dụng rõ ràng",
  },
  poor: {
    label: "Đã dùng lâu",
    color: "text-neutral-500",
    badgeColor: "bg-cream-50 text-neutral-500 border-luxury-ink/10",
