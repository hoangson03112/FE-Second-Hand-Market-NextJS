    ...
    <div className="flex flex-col items-center py-24 text-center">
      ...
      >
        <div
          ...
          style={{ background: "radial-gradient(circle, var(--luxury-champagne) 0%, transparent 70%)" }}
        />
      ...
      <p className="mt-2 max-w-sm text-sm leading-relaxed text-neutral-500">
        Sử dụng ô tìm kiếm trên thanh menu để khám phá hàng ngàn sản phẩm second-hand chất lượng
      </p>

      <div className="mt-8 flex flex-col items-center gap-3">
        <p className="flex items-center gap-1.5 text-[10px] font-semibold uppercase tracking-[0.18em] text-taupe-400">
          <IconSparkles className="h-3.5 w-3.5 text-luxury-champagne" strokeWidth={1.75} />
          Gợi ý tìm kiếm
        </p>
