...
const BUTTON_BASE =
  "flex w-full items-center justify-center gap-2 rounded-[2px] py-3.5 text-xs font-bold uppercase tracking-[0.22em] transition-all duration-300 disabled:opacity-50";
