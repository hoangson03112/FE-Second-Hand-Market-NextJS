...
export default function ShippingInfo({
  ...
  if (error) {
    return (
      <div className="flex flex-col gap-3 p-4 bg-destructive/8 border-2 border-destructive/20 rounded-xl">
        <div className="flex items-start gap-3">
          <IconAlertCircle className="h-5 w-5 text-destructive flex-shrink-0 mt-0.5" />
          <div className="flex-1">
            <p className="text-sm font-medium text-destructive mb-1">Không thể tính phí vận chuyển</p>
