      ...
      <div>
        ...
        <div className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium text-foreground mb-2">Họ và tên <span className="text-destructive">*</span></label>
              <input
                type="text"
                name="fullName"
          ...
          <div>
            <label className="block text-sm font-medium text-foreground mb-2">Địa chỉ <span className="text-destructive">*</span></label>
            <input
              type="text"
              name="address"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
              <label className="block text-sm font-medium text-foreground mb-2">Quận/Huyện <span className="text-destructive">*</span></label>
              <select
                name="district"
            ...
            <div>
              <label className="block text-sm font-medium text-foreground mb-2">Phường/Xã <span className="text-destructive">*</span></label>
              <select
                name="ward"
                value={formData.ward}
                onChange={handleChangeAndSubmit}
          ...
          <div>
            <label className="block text-sm font-medium text-foreground mb-2">Ghi chú (không bắt buộc)</label>
            <textarea
              name="note"
              value={formData.note}
