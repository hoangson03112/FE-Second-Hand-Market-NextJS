...
export default function Checkout() {
  ...
  const handleBack = async () => {
    const confirmed = await confirm({
      ...
      message:
        "CÃ¡c thÃ´ng tin báº¡n Ä‘Ã£ chá»n sáº½ Ä‘Æ°á»£c lÆ°u láº¡i. Báº¡n cÃ³ cháº¯c muá»‘n quay láº¡i?",
          ...
          {isMultiSeller && (
            <div className="flex items-start gap-4 p-5 mb-6 bg-taupe-50/50 border border-luxury-ink/10 rounded-[2px]">
              ...
              <p className="text-sm text-primary/90">
                Báº¡n Ä‘ang Ä‘áº·t hÃ ng tá»«{" "}
                <strong>{sellerGroups.length} ngÆ°á»i bÃ¡n</strong>. Má»—i Ä‘Æ¡n
                hÃ ng sáº½ Ä‘Æ°á»£c xá»­ lÃ½ riÃªng biá»‡t vÃ  cÃ³ thá»ƒ
                Ä‘Æ°á»£c giao vÃ o cÃ¡c thá»i Ä‘iá»ƒm khÃ¡c nhau. Báº¡n cÃ³
                thá»ƒ chá»n phÆ°Æ¡ng thá»©c thanh toÃ¡n khÃ¡c nhau cho tá»«ng
                Ä‘Æ¡n.
              </p>
            </div>
          )}
            ...
            <div className="lg:col-span-2 space-y-6">
              {sellerGroups.length === 0 ? (
                <div className="bg-white rounded-[2px] border border-luxury-ink/10 p-12 text-center text-taupe-600 text-sm">
                  Giá» hÃ ng trá»‘ng. Vui lÃ²ng thÃªm sáº£n pháº©m trÆ°á»›c khi
                  thanh toÃ¡n.
                </div>
              ) : (
              ...
              {!allLocalPickup && isCalculatingShipping && (
                <div className="flex items-center gap-4 p-5 bg-white rounded-[2px] border border-luxury-ink/10">
                  ...
                  <span className="text-sm text-gray-600">
                    Äang tÃ­nh phÃ­ váº­n chuyá»ƒn...
                  </span>
                </div>
              )}
            </div>
