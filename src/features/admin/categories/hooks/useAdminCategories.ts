...
export function useAdminCategories() {
  ...
  const updateCategoryMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      toast.success(ADMIN_MESSAGES.CATEGORY_UPDATE_SUCCESS);
    },
    onError: (err: unknown) => {
      const message =
  ...
  const createSubMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      setNewSubName("");
      setSubError(null);
      toast.success(ADMIN_MESSAGES.SUBCATEGORY_CREATE_SUCCESS);
    },
    onError: (err: unknown) => {
      const message =
        (err as { response?: { data?: { message?: string } } })?.response
  ...
  const updateSubMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      setSubNameDraft("");
      toast.success(ADMIN_MESSAGES.SUBCATEGORY_UPDATE_SUCCESS);
    },
    onError: (err: unknown) => {
      const message =
        (err as { response?: { data?: { message?: string } } })?.response
  ...
  const deleteSubMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      queryClient.invalidateQueries({ queryKey: ["categories"] });
      setSubError(null);
      toast.success(ADMIN_MESSAGES.SUBCATEGORY_DELETE_SUCCESS);
    },
    onError: (err: unknown) => {
      const message =
        (err as { response?: { data?: { message?: string } } })?.response
