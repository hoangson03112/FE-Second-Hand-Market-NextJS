...
export function PasswordForm({
  ...
  const getPasswordStrength = (password: string) => {
    ...
    if (strength <= 1)
      return { strength, label: "Yếu", color: "text-blush-600" };
    if (strength <= 3)
      return { strength, label: "Trung bình", color: "text-luxury-ink/70" };
          ...
          <div className="flex gap-3">
            ...
            <div>
              ...
              <ul className="text-xs text-luxury-ink/80 mt-2 space-y-1">
                <li>
                  • Ít nhất {PASSWORD_MIN_LENGTH} ký tự; nên có chữ hoa, thường,
                  số, ký tự đặc biệt
                </li>
                <li>
                  • Không dùng thông tin cá nhân dễ đoán, không chia sẻ mật khẩu
                </li>
              </ul>
            </div>
          </div>
            ...
            <div className="lg:col-span-2">
              ...
              <div className="relative">
                <input
                  ...
                  required
                />
                <IconLock className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-charcoal-500 pointer-events-none" />
                <button
                  type="button"
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                placeholder={
                  isGoogleUser
                    ? `Chọn mật khẩu (tối thiểu ${PASSWORD_MIN_LENGTH} ký tự)`
