...
export default function HeroImmersiveSection() {
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(120% 90% at 50% 0%, #F8F9F7 0%, #F1F2F0 55%, #E9EBE7 100%)",
        }}
      />

      {/* Layer 1: Generative Fluid Canvas */}
      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto px-6 lg:px-8 py-20 flex flex-col items-center text-center pointer-events-none drop-shadow-sm">
        ...
        >
          Nơi{" "}
          <span style={{ color: "#5FB160", letterSpacing: "-0.02em" }}>
            mọi thứ
          </span>
          <br />
