  ...
  return (
    ...
    >
      ...
      {action ? (
        <Link
          href={action.href}
          className="group inline-flex shrink-0 items-center gap-2 text-xs font-bold uppercase tracking-[0.22em] text-luxury-ink transition-colors hover:text-accent"
        >
          {action.label}
