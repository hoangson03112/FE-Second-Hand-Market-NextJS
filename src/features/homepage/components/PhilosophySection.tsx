  ...
  return (
    ...
    >
      <div className="mx-auto w-full max-w-[100rem] px-4 sm:px-6 lg:px-8">
        <div className="overflow-hidden rounded-2xl border border-taupe-200/80 bg-[#F8F4ED] shadow-[0_12px_32px_rgba(67,47,28,0.08)]">
          <div className="grid items-stretch lg:grid-cols-12">
            ...
            <div className="grid gap-3 border-t border-taupe-200/70 bg-[#FBF8F3] p-6 md:grid-cols-2 md:p-8 lg:col-span-7 lg:border-l lg:border-t-0 lg:p-10">
              {values.map((item, idx) => (
                <article
                  key={item.title}
                  className={`rounded-xl border border-taupe-200/80 bg-white/80 p-5 shadow-[0_6px_16px_rgba(66,48,30,0.06)] ${
                    idx === 2 ? "md:col-span-2" : ""
                  }`}
                >
