    ...
    <div className="bg-gradient-to-br from-cream-50 to-white border-2 border-border rounded-2xl p-5 shadow-md">
      ...
      <div className="space-y-2">
        ...
        <div className="pt-2 border-t-2 border-border flex justify-between items-center">
          <span className="font-bold text-taupe-900">Tổng cộng</span>
        ...
        <div className="flex items-center gap-1.5 pt-1">
          {order.statusPayment ? (
            <>
              ...
              <span className="text-sm text-taupe-900 font-medium">
                Đã thanh toán
              </span>
            </>
          ) : (
            <>
              ...
              <span className="text-sm text-taupe-500 font-medium">
                Chưa thanh toán
              </span>
            </>
          )}
