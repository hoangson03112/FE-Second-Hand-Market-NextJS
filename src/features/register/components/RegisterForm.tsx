...
import { UserIcon, EmailIcon, PhoneIcon, ArrowRightIcon } from "@/components/shared";
    ...
    <form className="space-y-7 mt-4" onSubmit={handleSubmit}>
      <div className="space-y-5">
        ...
        <div className="space-y-2">
          <label htmlFor="fullName" className="block text-[14px] font-semibold text-taupe-900">
        ...
        {/* Username Field */}
        <div className="space-y-2">
          <label htmlFor="username" className="block text-[14px] font-semibold text-taupe-900">
        ...
        {/* Phone Field */}
        <div className="space-y-2">
          <label htmlFor="phoneNumber" className="block text-[14px] font-semibold text-taupe-900">
