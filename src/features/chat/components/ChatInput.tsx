  ...
  return (
    ...
    >
      ...
      {selectedFiles.length > 0 && (
        <div className="mb-3 rounded-xl border border-border bg-taupe-50/60 p-3">
          <div className="flex items-center justify-between mb-2">
            ...
            <button
              ...
              className="ml-3 text-taupe-500 hover:text-taupe-900"
              disabled={sending}
      ...
      <div className="flex gap-3">
        {showAttachment && (
          <label className="cursor-pointer border-2 border-border px-4 py-3.5 rounded-xl hover:bg-taupe-100 transition-all">
            <input
              type="file"
              accept="image/*,video/*"
              multiple
            ...
            />
            <span className="flex items-center gap-2 text-sm font-medium text-taupe-900">
