        ...
        <form onSubmit={onSubmit} className="p-6 space-y-4">
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              className="flex-1 py-3 px-6 bg-primary text-primary-foreground rounded-full font-bold hover:bg-primary/90 hover:shadow-lg hover:shadow-primary/30 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
            >
