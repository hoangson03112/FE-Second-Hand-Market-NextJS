...
export default function SellerDashboard() {
  ...
  const statCards = [
    { label: "Sá»‘ dÆ° vÃ­", value: formatPrice(wallet?.balance ?? 0), Icon: IconCoins, color: "text-green-600", bg: "bg-green-50", border: "border-green-100" },
    { label: "Chá» rÃºt", value: formatPrice(wallet?.pendingBalance ?? 0), Icon: IconChartBar, color: "text-amber-600", bg: "bg-amber-50", border: "border-amber-100" },
    { label: "Doanh thu 7 ngÃ y", value: formatPrice(weekRevenue), Icon: IconTrendingUp, color: "text-primary", bg: "bg-primary/8", border: "border-primary/15" },
    { label: "Doanh thu 30 ngÃ y", value: formatPrice(monthRevenue), Icon: IconCoins, color: "text-blue-600", bg: "bg-blue-50", border: "border-blue-100" },
  ];

  const actionCards = [
    { href: "/seller/orders", label: "Quáº£n lÃ½ Ä‘Æ¡n hÃ ng", sub: `${pending} chá» xÃ¡c nháº­n â€¢ ${shipping} Ä‘ang giao`, Icon: IconTruck },
    { href: "/my/listings", label: "Sáº£n pháº©m Ä‘Ã£ Ä‘Äƒng", sub: "Chá»‰nh sá»­a, Ä‘Äƒng thÃªm", Icon: IconPackage },
    { href: "/seller/payouts", label: "VÃ­ & Thanh toÃ¡n", sub: `Tá»•ng thu: ${formatPrice(wallet?.totalEarned ?? 0)}`, Icon: IconBolt },
  ];
  ...
  return (
    <main className="max-w-8xl mx-auto w-full px-4 py-8 sm:px-6">
      ...
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-foreground mb-0.5">Tá»•ng quan Seller</h1>
        <p className="text-sm text-muted-foreground">Xem nhanh doanh thu vÃ  Ä‘Æ¡n hÃ ng cá»§a báº¡n</p>
      </div>
        ...
        <>
          ...
          {pending > 0 && (
            <div className="mt-6 p-4 rounded-xl border border-orange-200 bg-orange-50 flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-medium text-orange-800">Báº¡n cÃ³ {pending} Ä‘Æ¡n chá» xÃ¡c nháº­n</p>
