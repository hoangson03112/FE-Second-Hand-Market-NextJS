      ...
      {pagination && onPageChange && (
        <div className="border-t border-luxury-ink/10 py-10">
          <div className="flex flex-col items-center gap-8 md:flex-row md:justify-between md:gap-6">
            <p className="order-2 text-[11px] font-bold uppercase tracking-[0.15em] text-charcoal-400 md:order-1 md:w-44">
              Trang{" "}
            ...
            {pagination.total > 0 && (
              <p className="order-3 text-[11px] font-bold uppercase tracking-[0.15em] text-charcoal-400 md:w-44 md:text-right">
                <span className="text-luxury-ink">
