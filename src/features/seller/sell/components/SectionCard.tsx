  ...
  return (
    ...
    >
      <div className="flex shrink-0 items-center gap-3 border-b border-luxury-ink/10 bg-cream-50/70 px-4 py-3">
        <div className="flex h-5 w-5 items-center justify-center rounded-[2px] border border-luxury-ink/10 bg-white">
          <Icon className="h-3.5 w-3.5 text-luxury-ink" />
        </div>
        <h3 className="text-2xs font-semibold uppercase tracking-[0.2em] text-luxury-ink">
          {title}
        </h3>
      </div>
