...
export default function AuthSubmitButton({
  ...
  return (
    <button
      ...
      className={cn(
        "group relative flex w-full items-center justify-center rounded-[2px] bg-luxury-ink px-10 py-4 text-xs font-bold uppercase tracking-[0.24em] text-luxury-ivory transition-all duration-300",
