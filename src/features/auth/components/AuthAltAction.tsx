...
export default function AuthAltAction({
  ...
  return (
    <div className="border-t border-luxury-ink/10 pt-6 text-center">
      ...
      <Link
        href={href}
        className="group mt-2.5 inline-flex items-center gap-2 text-xs font-bold uppercase tracking-[0.22em] text-luxury-ink transition-colors hover:text-taupe-700"
      >
        {label}
