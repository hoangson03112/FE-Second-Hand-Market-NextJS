...
export default function AuthAltAction({
  ...
  return (
    <div className="border-t border-luxury-ink/10 pt-6 text-center">
      <p className="text-xs text-neutral-500">{question}</p>
      <Link
        href={href}
        className="group mt-2.5 inline-flex items-center gap-2 text-[11px] font-semibold uppercase tracking-[0.22em] text-luxury-ink transition-colors hover:text-accent"
      >
        {label}
