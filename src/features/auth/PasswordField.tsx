    ...
    <div className="space-y-2">
      ...
      <div className="relative">
        ...
        <input
          ...
          onChange={onChange}
          onBlur={onBlur}
          className={`${className} block w-full pl-12 pr-12 py-3.5 border bg-white text-foreground text-[15px] rounded-xl  focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all ${
            error
