      ...
      <div className="flex justify-center mb-4">
        {bankInfoLoading ? (
          ...
          <div className="w-64 h-64 bg-muted rounded-lg flex items-center justify-center border-2 border-dashed border-border p-4">
            <p className="text-sm text-destructive text-center">{bankInfoError}</p>
          </div>
          ...
          <div className="w-94 bg-cream-50 rounded-lg flex items-center justify-center border-2 border-border">
            ...
            <img
              ...
              onError={(e) => {
                ...
                if (parent) {
                  parent.innerHTML =
                    '<div class="w-full h-full flex items-center justify-center p-4"><p class="text-sm text-destructive text-center">Không thể tải QR code. Vui lòng kiểm tra lại thông tin ngân hàng.</p></div>';
                }
              }}
            />
          </div>
