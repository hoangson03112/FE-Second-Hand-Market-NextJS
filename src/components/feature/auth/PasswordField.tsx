    ...
    <div className="space-y-2">
      ...
      <div className="relative group">
        ...
        <input
          ...
          onChange={onChange}
          onBlur={onBlur}
          className={`block w-full pl-12 pr-12 py-4 bg-gray-50/50 border-2 rounded-xl text-base text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all duration-200 ${
