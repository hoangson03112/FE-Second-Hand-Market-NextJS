...
export default function CartLoginPrompt() {
  return (
    <div className="flex flex-col items-center justify-center py-16 px-6 text-center bg-gradient-to-br from-white to-cream-50 rounded-2xl border-2 border-border shadow-xl max-w-md mx-auto">
      ...
      <Link
        href="/login"
        className="inline-flex items-center justify-center h-11 px-8 bg-gradient-to-r from-primary to-accent text-white text-sm font-bold rounded-xl hover:shadow-lg hover:scale-105 transition-all duration-300"
      >
        Đăng Nhập
      </Link>
    </div>
