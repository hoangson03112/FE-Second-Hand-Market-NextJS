        ...
        {category && category.subCategories && category.subCategories.length > 0 && (
          <div className="flex flex-wrap gap-2">
            {!isSubCategoryView && (
              <Link
                href={`/categories/${category.slug}`}
                className="px-4 py-1.5 rounded-full border-2 border-primary bg-primary text-white text-sm font-semibold shadow-sm"
              >
                Tất cả
              </Link>
            )}
                ...
                <Link
                  ...
                  className={cn(
                    ...
                    isActive
                      ...
                      : "border-taupe-200 bg-white/70 text-taupe-600 hover:border-primary/60 hover:text-primary hover:bg-primary/5"
                  )}
                >
                  {sub.name}
                </Link>
