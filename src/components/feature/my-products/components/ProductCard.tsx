import { IconPackage, IconCalendar, IconEdit, IconTrash, IconAlertCircle, IconEye, IconTag } from "@tabler/icons-react";
            ...
            product.aiModerationResult?.rejectionReason && (
              <div className="p-2 rounded-lg bg-red-50 border border-red-200 mb-3">
                <div className="flex items-start gap-1.5">
                  <IconAlertCircle className="w-3.5 h-3.5 text-red-600 shrink-0 mt-0.5" />
