      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map((feature, index) => (
            ...
            >
              <div className="text-5xl mb-4 text-center animate-float-slow">
                {feature.icon}
              </div>
              <h3 className="text-xl font-bold mb-2 text-center text-neutral-900">
                {feature.title}
              </h3>
              <p className="text-neutral-700 text-center leading-relaxed font-medium">
                {feature.description}
              </p>
            </div>
          ))}
