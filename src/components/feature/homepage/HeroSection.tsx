    ...
    <section className="relative min-h-[70vh] overflow-hidden rounded-b-[32px] shadow-lg bg-gradient-to-br from-cream-50 via-white to-taupe-50">
      ...
      <div className="relative z-30 container mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div
            className={cn(
              "inline-block mb-6 animate-fade-in-down animation-delay-100"
            )}
          >
          ...
          >
            <Link
              href="/products"
              className="btn btn-primary btn-lg btn-rounded hover-lift shadow-primary"
            >
              Khám phá sản phẩm
            </Link>
            <Link
          ...
          >
            {stats.slice(0, 3).map((stat, index) => (
              <div key={index} className="text-center">
                <div className="text-2xl md:text-3xl font-bold mb-1 text-primary drop-shadow-md">
                  {stat.number}
                </div>
