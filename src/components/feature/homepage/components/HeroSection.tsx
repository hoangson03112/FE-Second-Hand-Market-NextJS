          ...
          <div className="max-w-lg">
            ...
            >
              ...
              >
                <span
                  className="w-6 h-px"
                  style={{ background: "#C47B5A", display: "inline-block" }}
                />
            ...
            >
              Mua &amp; bán đồ cũ
              <br />
              <span style={{ color: "#C47B5A" }}>dễ dàng &amp; tin cậy</span>
            </h1>
          ...
          >
            ...
            <div style={{ position: "absolute", top: "18px", left: "40px", animation: "floatA 5s ease-in-out infinite" }}>
              <svg width="80" height="68" viewBox="0 0 80 68" fill="none">
                ...
                {/* flash */}
                <rect x="46" y="12" width="14" height="10" rx="3" fill="#C47B5A"/>
                {/* lens outer */}
                <circle cx="40" cy="41" r="16" fill="#1A1714" stroke="#C47B5A" strokeWidth="2"/>
                {/* lens inner */}
                <circle cx="40" cy="41" r="10" fill="#3A2A1E"/>
                {/* lens shine */}
                <circle cx="35" cy="36" r="3" fill="white" opacity="0.25"/>
                {/* shutter button */}
                <circle cx="60" cy="20" r="4" fill="#C47B5A"/>
                {/* strap lug left */}
                <rect x="2" y="28" width="7" height="10" rx="2" fill="#C47B5A"/>
                {/* strap lug right */}
                <rect x="71" y="28" width="7" height="10" rx="2" fill="#C47B5A"/>
              </svg>
            </div>
            ...
            <div style={{ position: "absolute", top: "10px", right: "50px", animation: "floatB 6s ease-in-out infinite 0.8s" }}>
              <svg width="76" height="76" viewBox="0 0 76 76" fill="none">
                ...
                {/* label (doesn't spin) */}
                <circle cx="38" cy="38" r="12" fill="#C47B5A"/>
            ...
            <div style={{ position: "absolute", top: "160px", left: "20px", animation: "floatE 4.5s ease-in-out infinite 0.3s" }}>
              <svg width="72" height="58" viewBox="0 0 72 58" fill="none">
                {/* bottom book */}
                <rect x="4" y="40" width="64" height="14" rx="2" fill="#C47B5A"/>
            ...
            <div style={{ position: "absolute", top: "110px", left: "50%", transform: "translateX(-30%)", animation: "floatC 5.5s ease-in-out infinite 0.5s" }}>
              <svg width="70" height="90" viewBox="0 0 70 90" fill="none">
                {/* shade */}
                <path d="M10 38 L22 8 L48 8 L60 38 Z" fill="#C47B5A"/>
            ...
            <div style={{ position: "absolute", top: "200px", right: "30px", animation: "floatD 4s ease-in-out infinite 1.2s" }}>
              <svg width="60" height="62" viewBox="0 0 60 62" fill="none">
                ...
                {/* mug pattern */}
                <path d="M18 30 Q23 26 28 30 Q33 34 38 30" stroke="#C47B5A" strokeWidth="1.5" fill="none" strokeLinecap="round"/>
                {/* handle */}
            ...
            <div style={{ position: "absolute", bottom: "50px", left: "55px", animation: "floatF 5s ease-in-out infinite 0.2s" }}>
              <svg width="78" height="36" viewBox="0 0 78 36" fill="none">
                ...
                {/* left lens */}
                <rect x="10" y="4" width="24" height="22" rx="11" fill="none" stroke="#C47B5A" strokeWidth="2.5"/>
                <rect x="10" y="4" width="24" height="22" rx="11" fill="#C47B5A" opacity="0.12"/>
                {/* right lens */}
                <rect x="44" y="4" width="24" height="22" rx="11" fill="none" stroke="#C47B5A" strokeWidth="2.5"/>
                <rect x="44" y="4" width="24" height="22" rx="11" fill="#C47B5A" opacity="0.12"/>
                {/* bridge */}
            ...
            <div style={{ position: "absolute", top: "70px", left: "48%", animation: "floatA 3.8s ease-in-out infinite 1.5s" }}>
              <svg width="42" height="42" viewBox="0 0 42 42" fill="none">
                <circle cx="14" cy="14" r="11" fill="none" stroke="#C47B5A" strokeWidth="3"/>
                <circle cx="14" cy="14" r="5" fill="#C47B5A" opacity="0.3"/>
                <line x1="22" y1="22" x2="40" y2="38" stroke="#C47B5A" strokeWidth="3" strokeLinecap="round"/>
                <line x1="32" y1="30" x2="32" y2="36" stroke="#C47B5A" strokeWidth="2.5" strokeLinecap="round"/>
                <line x1="36" y1="34" x2="36" y2="38" stroke="#C47B5A" strokeWidth="2.5" strokeLinecap="round"/>
              </svg>
            </div>
            ...
            <div style={{ position: "absolute", bottom: "35px", right: "45px", animation: "floatB 6.5s ease-in-out infinite 0.7s" }}>
              <svg width="52" height="64" viewBox="0 0 52 64" fill="none">
                <path d="M4 8 L48 8 L48 54 L26 64 L4 54 Z" fill="#EDE0D4" stroke="#C47B5A" strokeWidth="1.5"/>
                <circle cx="26" cy="8" r="4" fill="none" stroke="#C47B5A" strokeWidth="1.5"/>
                ...
                <text x="26" y="50" textAnchor="middle" fontSize="8" fontWeight="700" fill="#C47B5A" fontFamily="sans-serif">₫ CŨ</text>
              </svg>
            </div>
