...
import { IconPackage, IconCircleCheck, IconCircleX, IconEye, IconX, IconLoader2, IconExternalLink } from "@tabler/icons-react";
          ...
          >
            <div className="flex items-center justify-between px-4 py-3 border-b border-border shrink-0">
              ...
              <div className="flex items-center gap-2">
                ...
                >
                  Xem trang SP <IconExternalLink className="w-3 h-3" />
                </Link>
                <button
                  type="button"
                  onClick={() => setSelectedProduct(null)}
