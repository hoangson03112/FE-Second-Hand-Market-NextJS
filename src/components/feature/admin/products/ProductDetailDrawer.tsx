...
import { ProductDrawerHeader } from "./components/ProductDrawerHeader";
import { ProductDrawerFooter } from "./components/ProductDrawerFooter";
import { SectionTitle, InfoRow } from "./components/DrawerHelpers";
