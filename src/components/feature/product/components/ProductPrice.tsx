      ...
      {hasPersonalDiscount && originalPrice ? (
        <div className="flex flex-col gap-2">
          <div className="flex items-center gap-3">
            ...
            <span className="px-3 py-1 text-xs font-bold text-white bg-red-500 rounded-lg shadow-md animate-pulse">
              GIÁ ĐẶC BIỆT
            </span>
          </div>
          ...
          <p className="text-xs text-taupe-500 mt-1 bg-amber-50 border border-amber-200 rounded-lg px-3 py-2">
