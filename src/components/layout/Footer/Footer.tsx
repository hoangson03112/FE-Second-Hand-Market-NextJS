      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="py-12 md:py-16">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12">
              ...
              <div className="flex items-center gap-4">
                {socialLinks.map((social) => (
                  <Link
                    ...
                    className={cn(
                      "w-10 h-10 rounded-full bg-neutral-100",
            ...
            {/* About Column */}
            <div>
              <h3 className="text-lg font-bold mb-4 text-neutral-900">Về chúng tôi</h3>
            ...
            {/* Support Column */}
            <div>
              <h3 className="text-lg font-bold mb-4 text-neutral-900">Hỗ trợ</h3>
              <ul className="space-y-3">
            ...
            {/* Legal & Categories Column */}
            <div>
              <h3 className="text-lg font-bold mb-4 text-neutral-900">Chính sách</h3>
              ...
              <h3 className="text-lg font-bold mb-4 text-neutral-900 mt-6">Danh mục</h3>
              <ul className="space-y-3">
